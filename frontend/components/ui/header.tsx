    ...
    return (
        <div className="fixed w-full top-0 left-0 z-99">
            <div className="relative z-10 flex justify-center p-6 w-full top-0">
                <nav className="flex items-center justify-between gap-8 px-8 py-4 rounded-full bg-black/30 backdrop-blur-xl border border-white/10 shadow-2xl max-w-6xl w-full">
